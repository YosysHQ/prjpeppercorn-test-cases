...
always @(*) begin
    ...
    if ((builder_csr_bankarray_csrbank1_sel & (builder_csr_bankarray_interface1_bank_bus_adr[8:0] == 1'd0))) begin
        ...
        builder_csr_bankarray_csrbank1_w0_we <= builder_csr_bankarray_interface1_bank_bus_re;
    end
end
...
always @(*) begin
    ...
    if ((builder_csr_bankarray_csrbank1_sel & (builder_csr_bankarray_interface1_bank_bus_adr[8:0] == 1'd1))) begin
        ...
        builder_csr_bankarray_csrbank1_r_we <= builder_csr_bankarray_interface1_bank_bus_re;
    end
end
assign main_scl = main__w_storage[0];
assign main_oe = main__w_storage[1];
assign main_sda0 = main__w_storage[2];
assign builder_csr_bankarray_csrbank1_w0_w = main__w_storage;
...
always @(posedge sys_clk) begin
    ...
    if (builder_csr_bankarray_csrbank1_w0_re) begin
        main__w_storage <= builder_csr_bankarray_csrbank1_w0_r;
    end
...
//------------------------------------------------------------------------------
// Memory rom: 6970-words x 32-bit
//------------------------------------------------------------------------------
...
// -----------------------------------------------------------------------------
//  Auto-Generated by LiteX on 2025-05-17 20:12:16.
//------------------------------------------------------------------------------
