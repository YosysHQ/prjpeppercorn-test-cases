...
always @(*) begin
    ...
    case (builder_grant)
        1'd0: begin
            builder_self0 <= main_basesoc_interface0_adapted_interface_adr;
        end
        default: begin
            builder_self0 <= main_basesoc_interface1_adapted_interface_adr;
        end
    endcase
end
always @(*) begin
    ...
    case (builder_grant)
        1'd0: begin
            builder_self1 <= main_basesoc_interface0_adapted_interface_dat_w;
        end
        default: begin
            builder_self1 <= main_basesoc_interface1_adapted_interface_dat_w;
        end
    endcase
end
always @(*) begin
    ...
    case (builder_grant)
        1'd0: begin
            builder_self2 <= main_basesoc_interface0_adapted_interface_sel;
        end
        default: begin
            builder_self2 <= main_basesoc_interface1_adapted_interface_sel;
        end
    endcase
end
always @(*) begin
    ...
    case (builder_grant)
        1'd0: begin
            builder_self3 <= main_basesoc_interface0_adapted_interface_cyc;
        end
        default: begin
            builder_self3 <= main_basesoc_interface1_adapted_interface_cyc;
        end
    endcase
end
always @(*) begin
    ...
    case (builder_grant)
        1'd0: begin
            builder_self4 <= main_basesoc_interface0_adapted_interface_stb;
        end
        default: begin
            builder_self4 <= main_basesoc_interface1_adapted_interface_stb;
        end
    endcase
end
always @(*) begin
    ...
    case (builder_grant)
        1'd0: begin
            builder_self5 <= main_basesoc_interface0_adapted_interface_we;
        end
        default: begin
            builder_self5 <= main_basesoc_interface1_adapted_interface_we;
        end
    endcase
end
always @(*) begin
    ...
    case (builder_grant)
        1'd0: begin
            builder_self6 <= main_basesoc_interface0_adapted_interface_cti;
        end
        default: begin
            builder_self6 <= main_basesoc_interface1_adapted_interface_cti;
        end
    endcase
end
always @(*) begin
    ...
    case (builder_grant)
        1'd0: begin
            builder_self7 <= main_basesoc_interface0_adapted_interface_bte;
        end
        default: begin
            builder_self7 <= main_basesoc_interface1_adapted_interface_bte;
        end
    endcase
end
...
//------------------------------------------------------------------------------
// Memory rom: 9396-words x 32-bit
//------------------------------------------------------------------------------
...
//------------------------------------------------------------------------------
// Instance mor1kx of mor1kx Module.
//------------------------------------------------------------------------------
mor1kx #(
	// Parameters.
	...
	// Inputs.
	.clk        (sys_clk),
	.dwbm_ack_i (main_basesoc_dbus_ack),
	.dwbm_dat_i (main_basesoc_dbus_dat_r),
	.dwbm_err_i (main_basesoc_dbus_err),
	.dwbm_rty_i (1'd0),
	.irq_i      (main_basesoc_interrupt),
	.iwbm_ack_i (main_basesoc_ibus_ack),
	.iwbm_dat_i (main_basesoc_ibus_dat_r),
	.iwbm_err_i (main_basesoc_ibus_err),
	.iwbm_rty_i (1'd0),
	.rst        ((sys_rst | main_basesoc_reset)),

	// Outputs.
	.dwbm_adr_o (main_basesoc_dbus_adr),
	.dwbm_bte_o (main_basesoc_dbus_bte),
	.dwbm_cti_o (main_basesoc_dbus_cti),
	.dwbm_cyc_o (main_basesoc_dbus_cyc),
	.dwbm_dat_o (main_basesoc_dbus_dat_w),
	.dwbm_sel_o (main_basesoc_dbus_sel),
	.dwbm_stb_o (main_basesoc_dbus_stb),
	.dwbm_we_o  (main_basesoc_dbus_we),
	.iwbm_adr_o (main_basesoc_ibus_adr),
	.iwbm_bte_o (main_basesoc_ibus_bte),
	.iwbm_cti_o (main_basesoc_ibus_cti),
	.iwbm_cyc_o (main_basesoc_ibus_cyc),
	.iwbm_dat_o (main_basesoc_ibus_dat_w),
	.iwbm_sel_o (main_basesoc_ibus_sel),
	.iwbm_stb_o (main_basesoc_ibus_stb),
	.iwbm_we_o  (main_basesoc_ibus_we)
);
...
// -----------------------------------------------------------------------------
//  Auto-Generated by LiteX on 2025-05-09 14:43:30.
//------------------------------------------------------------------------------
