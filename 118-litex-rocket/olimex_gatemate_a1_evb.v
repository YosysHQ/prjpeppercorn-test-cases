...
reg           main_rocket_l2fb_a2w_cmd_done_next_value0 = 1'd0;
reg           main_rocket_l2fb_a2w_cmd_done_next_value_ce0 = 1'd0;
reg           main_rocket_l2fb_a2w_data_done = 1'd0;
reg           main_rocket_l2fb_a2w_data_done_next_value1 = 1'd0;
reg           main_rocket_l2fb_a2w_data_done_next_value_ce1 = 1'd0;
...
reg           main_rocket_mem_axi_ar_ready = 1'd0;
...
reg           main_rocket_mem_axi_aw_ready = 1'd0;
wire          main_rocket_mem_axi_aw_valid;
reg     [3:0] main_rocket_mem_axi_b_param_id = 4'd0;
reg     [1:0] main_rocket_mem_axi_b_payload_resp = 2'd0;
wire          main_rocket_mem_axi_b_ready;
reg           main_rocket_mem_axi_b_valid = 1'd0;
reg           main_rocket_mem_axi_r_last = 1'd0;
reg     [3:0] main_rocket_mem_axi_r_param_id = 4'd0;
reg    [63:0] main_rocket_mem_axi_r_payload_data = 64'd0;
reg     [1:0] main_rocket_mem_axi_r_payload_resp = 2'd0;
wire          main_rocket_mem_axi_r_ready;
reg           main_rocket_mem_axi_r_valid = 1'd0;
...
reg           main_rocket_mmio_a2w_axi2axi_lite_cmd_done_axi2axilite_next_value0 = 1'd0;
reg           main_rocket_mmio_a2w_axi2axi_lite_cmd_done_axi2axilite_next_value_ce0 = 1'd0;
reg           main_rocket_mmio_a2w_axi2axi_lite_last_ar_aw_n = 1'd0;
reg           main_rocket_mmio_a2w_axi2axi_lite_last_ar_aw_n_axi2axilite_next_value1 = 1'd0;
reg           main_rocket_mmio_a2w_axi2axi_lite_last_ar_aw_n_axi2axilite_next_value_ce1 = 1'd0;
...
reg    [63:0] main_rocket_mmio_a2w_axi_lite2wishbone_data_axilite2wishbone_next_value1 = 64'd0;
reg           main_rocket_mmio_a2w_axi_lite2wishbone_data_axilite2wishbone_next_value_ce1 = 1'd0;
reg           main_rocket_mmio_a2w_axi_lite2wishbone_last_ar_aw_n = 1'd0;
reg           main_rocket_mmio_a2w_axi_lite2wishbone_last_ar_aw_n_axilite2wishbone_next_value0 = 1'd0;
reg           main_rocket_mmio_a2w_axi_lite2wishbone_last_ar_aw_n_axilite2wishbone_next_value_ce0 = 1'd0;
...
always @(*) begin
    ...
    main_rocket_mmio_a2w_axi2axi_lite_cmd_done_axi2axilite_next_value0 <= 1'd0;
    main_rocket_mmio_a2w_axi2axi_lite_cmd_done_axi2axilite_next_value_ce0 <= 1'd0;
    main_rocket_mmio_a2w_axi2axi_lite_last_ar_aw_n_axi2axilite_next_value1 <= 1'd0;
    main_rocket_mmio_a2w_axi2axi_lite_last_ar_aw_n_axi2axilite_next_value_ce1 <= 1'd0;
        ...
        1'd1: begin
            ...
            if ((main_rocket_mmio_a2w_axi2axi_lite_ax_beat_valid & main_rocket_mmio_a2w_axi2axi_lite_ax_beat_last)) begin
                if (main_rocket_mmio_a2w_ar_ready) begin
                    main_rocket_mmio_a2w_axi2axi_lite_ax_beat_ready <= 1'd0;
                    main_rocket_mmio_a2w_axi2axi_lite_cmd_done_axi2axilite_next_value0 <= 1'd1;
                    main_rocket_mmio_a2w_axi2axi_lite_cmd_done_axi2axilite_next_value_ce0 <= 1'd1;
                end
            end
        ...
        default: begin
            ...
            if ((main_rocket_mmio_axi_ar_valid & main_rocket_mmio_axi_aw_valid)) begin
                if (main_rocket_mmio_a2w_axi2axi_lite_last_ar_aw_n) begin
                    ...
                    main_rocket_mmio_a2w_axi2axi_lite_last_ar_aw_n_axi2axilite_next_value1 <= 1'd0;
                    main_rocket_mmio_a2w_axi2axi_lite_last_ar_aw_n_axi2axilite_next_value_ce1 <= 1'd1;
                    ...
                    main_rocket_mmio_a2w_axi2axi_lite_last_ar_aw_n_axi2axilite_next_value1 <= 1'd1;
                    main_rocket_mmio_a2w_axi2axi_lite_last_ar_aw_n_axi2axilite_next_value_ce1 <= 1'd1;
...
always @(*) begin
    ...
    main_rocket_mmio_a2w_axi_lite2wishbone_data_axilite2wishbone_next_value1 <= 64'd0;
    main_rocket_mmio_a2w_axi_lite2wishbone_data_axilite2wishbone_next_value_ce1 <= 1'd0;
    main_rocket_mmio_a2w_axi_lite2wishbone_last_ar_aw_n_axilite2wishbone_next_value0 <= 1'd0;
    main_rocket_mmio_a2w_axi_lite2wishbone_last_ar_aw_n_axilite2wishbone_next_value_ce0 <= 1'd0;
    ...
    case (builder_rocket_axilite2wishbone_state)
        1'd1: begin
            ...
            if (main_rocket_mmio_wb_ack) begin
                ...
                main_rocket_mmio_a2w_axi_lite2wishbone_data_axilite2wishbone_next_value1 <= main_rocket_mmio_wb_dat_r;
                main_rocket_mmio_a2w_axi_lite2wishbone_data_axilite2wishbone_next_value_ce1 <= 1'd1;
        ...
        default: begin
            if ((main_rocket_mmio_a2w_ar_valid & main_rocket_mmio_a2w_aw_valid)) begin
                if (main_rocket_mmio_a2w_axi_lite2wishbone_last_ar_aw_n) begin
                    main_rocket_mmio_a2w_axi_lite2wishbone_last_ar_aw_n_axilite2wishbone_next_value0 <= 1'd0;
                    main_rocket_mmio_a2w_axi_lite2wishbone_last_ar_aw_n_axilite2wishbone_next_value_ce0 <= 1'd1;
                    builder_rocket_axilite2wishbone_next_state <= 2'd3;
                end else begin
                    main_rocket_mmio_a2w_axi_lite2wishbone_last_ar_aw_n_axilite2wishbone_next_value0 <= 1'd1;
                    main_rocket_mmio_a2w_axi_lite2wishbone_last_ar_aw_n_axilite2wishbone_next_value_ce0 <= 1'd1;
...
always @(*) begin
    ...
    main_rocket_l2fb_a2w_cmd_done_next_value0 <= 1'd0;
    main_rocket_l2fb_a2w_cmd_done_next_value_ce0 <= 1'd0;
    main_rocket_l2fb_a2w_data_done_next_value1 <= 1'd0;
    main_rocket_l2fb_a2w_data_done_next_value_ce1 <= 1'd0;
    ...
    case (builder_rocket_state)
        1'd1: begin
            ...
            if ((main_rocket_l2fb_a2w_aw_valid & main_rocket_l2fb_a2w_aw_ready)) begin
                main_rocket_l2fb_a2w_cmd_done_next_value0 <= 1'd1;
                main_rocket_l2fb_a2w_cmd_done_next_value_ce0 <= 1'd1;
            end
            ...
            if ((main_rocket_l2fb_a2w_w_valid & main_rocket_l2fb_a2w_w_ready)) begin
                main_rocket_l2fb_a2w_data_done_next_value1 <= 1'd1;
                main_rocket_l2fb_a2w_data_done_next_value_ce1 <= 1'd1;
            end
...
assign builder_csr_bankarray_csrbank2_load0_w = main_timer_load_storage;
assign builder_csr_bankarray_csrbank2_reload0_w = main_timer_reload_storage;
...
always @(*) begin
    ...
    if ((builder_csr_bankarray_csrbank3_sel & (builder_csr_bankarray_interface3_bank_bus_adr[8:0] == 1'd0))) begin
        ...
        main_uart_rxtx_we <= builder_csr_bankarray_interface3_bank_bus_re;
    end
end
...
assign builder_csr_bankarray_csrbank3_ev_status_w = main_uart_status_status;
...
assign builder_csr_bankarray_csrbank3_ev_pending_w = main_uart_pending_status;
...
assign builder_csr_bankarray_csrbank3_ev_enable0_w = main_uart_enable_storage;
...
always @(*) begin
    ...
    case (builder_grant)
        default: begin
            builder_self0 <= main_socbushandler_adapted_interface_adr;
        end
    endcase
end
always @(*) begin
    ...
    case (builder_grant)
        default: begin
            builder_self1 <= main_socbushandler_adapted_interface_dat_w;
        end
    endcase
end
always @(*) begin
    ...
    case (builder_grant)
        default: begin
            builder_self2 <= main_socbushandler_adapted_interface_sel;
        end
    endcase
end
always @(*) begin
    ...
    case (builder_grant)
        default: begin
            builder_self3 <= main_socbushandler_adapted_interface_cyc;
        end
    endcase
end
always @(*) begin
    ...
    case (builder_grant)
        default: begin
            builder_self4 <= main_socbushandler_adapted_interface_stb;
        end
    endcase
end
always @(*) begin
    ...
    case (builder_grant)
        default: begin
            builder_self5 <= main_socbushandler_adapted_interface_we;
        end
    endcase
end
always @(*) begin
    ...
    case (builder_grant)
        default: begin
            builder_self6 <= main_socbushandler_adapted_interface_cti;
        end
    endcase
end
always @(*) begin
    ...
    case (builder_grant)
        default: begin
            builder_self7 <= main_socbushandler_adapted_interface_bte;
        end
    endcase
end
...
always @(posedge sys_clk) begin
    ...
    if (main_rocket_mmio_a2w_axi2axi_lite_cmd_done_axi2axilite_next_value_ce0) begin
        main_rocket_mmio_a2w_axi2axi_lite_cmd_done <= main_rocket_mmio_a2w_axi2axi_lite_cmd_done_axi2axilite_next_value0;
    end
    if (main_rocket_mmio_a2w_axi2axi_lite_last_ar_aw_n_axi2axilite_next_value_ce1) begin
        main_rocket_mmio_a2w_axi2axi_lite_last_ar_aw_n <= main_rocket_mmio_a2w_axi2axi_lite_last_ar_aw_n_axi2axilite_next_value1;
    end
    builder_rocket_axilite2wishbone_state <= builder_rocket_axilite2wishbone_next_state;
    if (main_rocket_mmio_a2w_axi_lite2wishbone_last_ar_aw_n_axilite2wishbone_next_value_ce0) begin
        main_rocket_mmio_a2w_axi_lite2wishbone_last_ar_aw_n <= main_rocket_mmio_a2w_axi_lite2wishbone_last_ar_aw_n_axilite2wishbone_next_value0;
    end
    if (main_rocket_mmio_a2w_axi_lite2wishbone_data_axilite2wishbone_next_value_ce1) begin
        main_rocket_mmio_a2w_axi_lite2wishbone_data <= main_rocket_mmio_a2w_axi_lite2wishbone_data_axilite2wishbone_next_value1;
    end
    builder_rocket_state <= builder_rocket_next_state;
    if (main_rocket_l2fb_a2w_cmd_done_next_value_ce0) begin
        main_rocket_l2fb_a2w_cmd_done <= main_rocket_l2fb_a2w_cmd_done_next_value0;
    end
    if (main_rocket_l2fb_a2w_data_done_next_value_ce1) begin
        main_rocket_l2fb_a2w_data_done <= main_rocket_l2fb_a2w_data_done_next_value1;
    end
    ...
    if (builder_csr_bankarray_csrbank2_load0_re) begin
        main_timer_load_storage <= builder_csr_bankarray_csrbank2_load0_r;
    end
    main_timer_load_re <= builder_csr_bankarray_csrbank2_load0_re;
    if (builder_csr_bankarray_csrbank2_reload0_re) begin
        main_timer_reload_storage <= builder_csr_bankarray_csrbank2_reload0_r;
    end
    ...
    if (builder_csr_bankarray_csrbank3_ev_pending_re) begin
        main_uart_pending_r <= builder_csr_bankarray_csrbank3_ev_pending_r;
    end
    main_uart_pending_re <= builder_csr_bankarray_csrbank3_ev_pending_re;
    if (builder_csr_bankarray_csrbank3_ev_enable0_re) begin
        main_uart_enable_storage <= builder_csr_bankarray_csrbank3_ev_enable0_r;
    end
...
//------------------------------------------------------------------------------
// Memory rom: 5007-words x 32-bit
//------------------------------------------------------------------------------
...
// -----------------------------------------------------------------------------
//  Auto-Generated by LiteX on 2025-09-03 16:30:46.
//------------------------------------------------------------------------------
