...
reg           builder_firev_next_state = 1'd0;
reg           builder_firev_state = 1'd0;
...
wire   [31:0] main_basesoc_idbus_adr;
...
wire   [31:0] main_basesoc_idbus_dat_w;
wire          main_basesoc_idbus_err;
wire    [3:0] main_basesoc_idbus_sel;
reg           main_basesoc_idbus_stb = 1'd0;
wire          main_basesoc_idbus_we;
wire   [31:0] main_basesoc_mbus_in_ram_data_out;
wire          main_basesoc_mbus_in_ram_done;
wire   [31:0] main_basesoc_mbus_out_ram_addr;
wire   [31:0] main_basesoc_mbus_out_ram_data_in;
wire          main_basesoc_mbus_out_ram_in_valid;
wire          main_basesoc_mbus_out_ram_rw;
wire    [3:0] main_basesoc_mbus_out_ram_wmask;
...
assign main_basesoc_idbus_we = main_basesoc_mbus_out_ram_rw;
assign main_basesoc_idbus_adr = main_basesoc_mbus_out_ram_addr;
assign main_basesoc_idbus_sel = main_basesoc_mbus_out_ram_wmask;
assign main_basesoc_idbus_dat_w = main_basesoc_mbus_out_ram_data_in;
assign main_basesoc_mbus_in_ram_data_out = main_basesoc_idbus_dat_r;
assign main_basesoc_mbus_in_ram_done = main_basesoc_idbus_ack;
always @(*) begin
    builder_firev_next_state <= 1'd0;
    main_basesoc_idbus_cyc <= 1'd0;
    main_basesoc_idbus_stb <= 1'd0;
    builder_firev_next_state <= builder_firev_state;
    case (builder_firev_state)
        1'd1: begin
        ...
        default: begin
            if (main_basesoc_mbus_out_ram_in_valid) begin
                main_basesoc_idbus_stb <= 1'd1;
                main_basesoc_idbus_cyc <= 1'd1;
                builder_firev_next_state <= 1'd1;
            end
        end
    endcase
end
...
always @(posedge sys_clk) begin
    ...
    builder_firev_state <= builder_firev_next_state;
...
//------------------------------------------------------------------------------
// Instance M_rv32i_cpu of M_rv32i_cpu Module.
//------------------------------------------------------------------------------
M_rv32i_cpu M_rv32i_cpu(
	// Inputs.
	.clock            (sys_clk),
	.in_boot_at       (32'd0),
	.in_ram_data_out  (main_basesoc_mbus_in_ram_data_out),
	.in_ram_done      (main_basesoc_mbus_in_ram_done),
	.reset            ((sys_rst | main_basesoc_reset)),

	// Outputs.
	.out_ram_addr     (main_basesoc_mbus_out_ram_addr),
	.out_ram_data_in  (main_basesoc_mbus_out_ram_data_in),
	.out_ram_in_valid (main_basesoc_mbus_out_ram_in_valid),
	.out_ram_rw       (main_basesoc_mbus_out_ram_rw),
	.out_ram_wmask    (main_basesoc_mbus_out_ram_wmask)
);
...
// -----------------------------------------------------------------------------
//  Auto-Generated by LiteX on 2025-05-09 14:14:22.
//------------------------------------------------------------------------------
