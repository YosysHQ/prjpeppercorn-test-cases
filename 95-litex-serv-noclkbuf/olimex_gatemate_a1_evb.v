...
// Device     : CCGM1A1
// LiteX sha1 : e0523ae51
// Date       : 2025-05-14 10:17:22
//------------------------------------------------------------------------------
...
always @(posedge sys_clk) begin
    ...
    {main_basesoc_tx_tick, main_basesoc_tx_phase} <= 26'd49478023;
    if (main_basesoc_tx_enable) begin
        {main_basesoc_tx_tick, main_basesoc_tx_phase} <= (main_basesoc_tx_phase + 26'd49478023);
    end
    ...
    if (main_basesoc_rx_enable) begin
        {main_basesoc_rx_tick, main_basesoc_rx_phase} <= (main_basesoc_rx_phase + 26'd49478023);
    end
...
//------------------------------------------------------------------------------
// Memory rom: 6093-words x 32-bit
//------------------------------------------------------------------------------
...
assign main_crg_clkout = main_crg_clkin;
assign builder_gatematepll_locked_s1 = 1'b1;
...
// -----------------------------------------------------------------------------
//  Auto-Generated by LiteX on 2025-05-14 10:17:22.
//------------------------------------------------------------------------------
