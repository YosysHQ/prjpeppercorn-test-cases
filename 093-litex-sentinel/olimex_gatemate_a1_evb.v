...
// Device     : CCGM1A1
// LiteX sha1 : 62c9b9eb3
// Date       : 2025-05-09 16:24:36
//------------------------------------------------------------------------------
...
└─── ctrl (SoCController)
└─── cpu (Sentinel)
│    └─── bridge (SentinelLitexBridge)
│    └─── sentinellitexbridge_0* (SentinelLitexBridge)
│    └─── [sentinel_cpu]
└─── rom (SRAM)
└─── sram (SRAM)
...
wire   [31:0] builder_slice_proxy0;
wire   [31:0] builder_slice_proxy1;
wire   [31:0] builder_slice_proxy2;
reg           builder_state = 1'd0;
reg     [7:0] builder_sync_self0 = 8'd0;
reg     [7:0] builder_sync_self1 = 8'd0;
reg     [7:0] builder_sync_self2 = 8'd0;
reg     [7:0] builder_sync_self3 = 8'd0;
wire          builder_wait;
...
reg           main_basesoc_bus_ack_override = 1'd0;
reg    [31:0] main_basesoc_bus_dat_r_override = 32'd0;
...
reg    [31:0] main_basesoc_interrupt_mask = 32'd0;
reg    [31:0] main_basesoc_interrupt_reg = 32'd0;
wire          main_basesoc_litex_bus_ack;
wire   [29:0] main_basesoc_litex_bus_adr;
wire    [1:0] main_basesoc_litex_bus_bte;
wire    [2:0] main_basesoc_litex_bus_cti;
reg           main_basesoc_litex_bus_cyc = 1'd0;
wire   [31:0] main_basesoc_litex_bus_dat_r;
wire   [31:0] main_basesoc_litex_bus_dat_w;
wire          main_basesoc_litex_bus_err;
wire    [3:0] main_basesoc_litex_bus_sel;
reg           main_basesoc_litex_bus_stb = 1'd0;
wire          main_basesoc_litex_bus_we;
wire   [31:0] main_basesoc_litex_interrupts;
...
reg           main_basesoc_sentinel_bus_ack = 1'd0;
wire   [29:0] main_basesoc_sentinel_bus_adr;
reg     [1:0] main_basesoc_sentinel_bus_bte = 2'd0;
reg     [2:0] main_basesoc_sentinel_bus_cti = 3'd0;
wire          main_basesoc_sentinel_bus_cyc;
reg    [31:0] main_basesoc_sentinel_bus_dat_r = 32'd0;
wire   [31:0] main_basesoc_sentinel_bus_dat_w;
wire          main_basesoc_sentinel_bus_err;
wire    [3:0] main_basesoc_sentinel_bus_sel;
wire          main_basesoc_sentinel_bus_stb;
wire          main_basesoc_sentinel_bus_we;
wire          main_basesoc_sentinel_irq;
...
wire   [31:0] main_basesoc_trampoline0;
wire   [31:0] main_basesoc_trampoline1;
reg    [31:0] main_basesoc_trampoline2 = 32'd0;
reg    [31:0] main_basesoc_trampoline3 = 32'd0;
...
assign main_basesoc_litex_bus_dat_r = builder_shared_dat_r;
assign main_basesoc_litex_bus_ack = (builder_shared_ack & (builder_grant == 1'd0));
assign main_basesoc_litex_bus_err = (builder_shared_err & (builder_grant == 1'd0));
assign builder_request = {main_basesoc_litex_bus_cyc};
assign builder_grant = 1'd0;
always @(*) begin
    builder_slave_sel <= 3'd0;
    builder_slave_sel[0] <= (builder_shared_adr[29:15] == 13'd4096);
    builder_slave_sel[1] <= (builder_shared_adr[29:11] == 17'd67584);
...
assign main_basesoc_litex_interrupts = main_basesoc_interrupt;
assign main_basesoc_litex_bus_adr = main_basesoc_sentinel_bus_adr;
assign main_basesoc_litex_bus_dat_w = main_basesoc_sentinel_bus_dat_w;
assign main_basesoc_litex_bus_sel = main_basesoc_sentinel_bus_sel;
assign main_basesoc_litex_bus_we = main_basesoc_sentinel_bus_we;
assign main_basesoc_litex_bus_cti = main_basesoc_sentinel_bus_cti;
assign main_basesoc_litex_bus_bte = main_basesoc_sentinel_bus_bte;
assign main_basesoc_sentinel_bus_err = main_basesoc_litex_bus_err;
always @(*) begin
    main_basesoc_sentinel_bus_ack <= 1'd0;
    main_basesoc_sentinel_bus_ack <= main_basesoc_litex_bus_ack;
    main_basesoc_sentinel_bus_ack <= (main_basesoc_litex_bus_ack | main_basesoc_bus_ack_override);
end
always @(*) begin
    main_basesoc_sentinel_bus_dat_r <= 32'd0;
    main_basesoc_sentinel_bus_dat_r <= main_basesoc_litex_bus_dat_r;
    main_basesoc_sentinel_bus_dat_r <= ((main_basesoc_sentinel_bus_adr[29:26] == 1'd0) ? main_basesoc_bus_dat_r_override : main_basesoc_litex_bus_dat_r);
end
always @(*) begin
    main_basesoc_litex_bus_cyc <= 1'd0;
    main_basesoc_litex_bus_cyc <= main_basesoc_sentinel_bus_cyc;
    main_basesoc_litex_bus_cyc <= (main_basesoc_sentinel_bus_cyc & (~(main_basesoc_sentinel_bus_adr[29:26] == 1'd0)));
end
always @(*) begin
    main_basesoc_litex_bus_stb <= 1'd0;
    main_basesoc_litex_bus_stb <= main_basesoc_sentinel_bus_stb;
    main_basesoc_litex_bus_stb <= (main_basesoc_sentinel_bus_stb & (~(main_basesoc_sentinel_bus_adr[29:26] == 1'd0)));
end
assign main_basesoc_sentinel_irq = ((main_basesoc_interrupt_reg & main_basesoc_interrupt_mask) != 1'd0);
assign main_basesoc_trampoline0 = {(builder_slice_proxy0[31:12] + builder_slice_proxy1[11]), 12'd791};
assign main_basesoc_trampoline1 = {builder_slice_proxy2[11:0], 18'd196711};
...
assign builder_csr_bankarray_csrbank2_load0_r = builder_csr_bankarray_interface2_bank_bus_dat_w;
always @(*) begin
...
assign builder_csr_bankarray_csrbank2_reload0_r = builder_csr_bankarray_interface2_bank_bus_dat_w;
always @(*) begin
...
assign builder_csr_bankarray_csrbank3_ev_status_w = main_basesoc_uart_status_status;
...
assign builder_csr_bankarray_csrbank3_ev_pending_w = main_basesoc_uart_pending_status;
...
assign builder_csr_bankarray_csrbank3_ev_enable0_w = main_basesoc_uart_enable_storage;
...
assign builder_slice_proxy0 = 32'd536870912;
assign builder_slice_proxy1 = 32'd536870912;
assign builder_slice_proxy2 = 32'd536870912;
always @(*) begin
    builder_comb_self0 <= 30'd0;
    case (builder_grant)
        default: begin
            builder_comb_self0 <= main_basesoc_litex_bus_adr;
        end
    endcase
end
always @(*) begin
    ...
    case (builder_grant)
        default: begin
            builder_comb_self1 <= main_basesoc_litex_bus_dat_w;
        end
    endcase
end
always @(*) begin
    ...
    case (builder_grant)
        default: begin
            builder_comb_self2 <= main_basesoc_litex_bus_sel;
        end
    endcase
end
always @(*) begin
    ...
    case (builder_grant)
        default: begin
            builder_comb_self3 <= main_basesoc_litex_bus_cyc;
        end
    endcase
end
always @(*) begin
    ...
    case (builder_grant)
        default: begin
            builder_comb_self4 <= main_basesoc_litex_bus_stb;
        end
    endcase
end
always @(*) begin
    ...
    case (builder_grant)
        default: begin
            builder_comb_self5 <= main_basesoc_litex_bus_we;
        end
    endcase
end
always @(*) begin
    ...
    case (builder_grant)
        default: begin
            builder_comb_self6 <= main_basesoc_litex_bus_cti;
        end
    endcase
end
always @(*) begin
    ...
    case (builder_grant)
        default: begin
            builder_comb_self7 <= main_basesoc_litex_bus_bte;
        end
    endcase
end
always @(*) begin
    builder_sync_self0 <= 8'd0;
    case (main_basesoc_sentinel_bus_adr)
        1'd0: begin
            builder_sync_self0 <= main_basesoc_trampoline0[7:0];
        end
        1'd1: begin
            builder_sync_self0 <= main_basesoc_trampoline1[7:0];
        end
        2'd2: begin
            builder_sync_self0 <= main_basesoc_trampoline2[7:0];
        end
        default: begin
            builder_sync_self0 <= main_basesoc_trampoline3[7:0];
        end
    endcase
end
always @(*) begin
    builder_sync_self1 <= 8'd0;
    case (main_basesoc_sentinel_bus_adr)
        1'd0: begin
            builder_sync_self1 <= main_basesoc_trampoline0[15:8];
        end
        1'd1: begin
            builder_sync_self1 <= main_basesoc_trampoline1[15:8];
        end
        2'd2: begin
            builder_sync_self1 <= main_basesoc_trampoline2[15:8];
        end
        default: begin
            builder_sync_self1 <= main_basesoc_trampoline3[15:8];
        end
    endcase
end
always @(*) begin
    builder_sync_self2 <= 8'd0;
    case (main_basesoc_sentinel_bus_adr)
        1'd0: begin
            builder_sync_self2 <= main_basesoc_trampoline0[23:16];
        end
        1'd1: begin
            builder_sync_self2 <= main_basesoc_trampoline1[23:16];
        end
        2'd2: begin
            builder_sync_self2 <= main_basesoc_trampoline2[23:16];
        end
        default: begin
            builder_sync_self2 <= main_basesoc_trampoline3[23:16];
        end
    endcase
end
always @(*) begin
    builder_sync_self3 <= 8'd0;
    case (main_basesoc_sentinel_bus_adr)
        1'd0: begin
            builder_sync_self3 <= main_basesoc_trampoline0[31:24];
        end
        1'd1: begin
            builder_sync_self3 <= main_basesoc_trampoline1[31:24];
        end
        2'd2: begin
            builder_sync_self3 <= main_basesoc_trampoline2[31:24];
        end
        default: begin
            builder_sync_self3 <= main_basesoc_trampoline3[31:24];
        end
    endcase
end
...
always @(posedge sys_clk) begin
    ...
    main_basesoc_bus_ack_override <= 1'd0;
    if (((main_basesoc_sentinel_bus_cyc & main_basesoc_sentinel_bus_stb) & (~main_basesoc_sentinel_bus_ack))) begin
        if ((~main_basesoc_sentinel_bus_we)) begin
            if (((main_basesoc_sentinel_bus_adr >= 1'd0) & (main_basesoc_sentinel_bus_adr < 3'd4))) begin
                if ((main_basesoc_sentinel_bus_sel & 1'd1)) begin
                    main_basesoc_bus_dat_r_override[7:0] <= builder_sync_self0;
                end
                if ((main_basesoc_sentinel_bus_sel & 2'd2)) begin
                    main_basesoc_bus_dat_r_override[15:8] <= builder_sync_self1;
                end
                if ((main_basesoc_sentinel_bus_sel & 3'd4)) begin
                    main_basesoc_bus_dat_r_override[23:16] <= builder_sync_self2;
                end
                if ((main_basesoc_sentinel_bus_sel & 4'd8)) begin
                    main_basesoc_bus_dat_r_override[31:24] <= builder_sync_self3;
                end
                main_basesoc_bus_ack_override <= 1'd1;
            end else begin
                if ((main_basesoc_sentinel_bus_adr == 3'd4)) begin
                    if ((main_basesoc_sentinel_bus_sel & 1'd1)) begin
                        main_basesoc_bus_dat_r_override[7:0] <= main_basesoc_interrupt_reg[7:0];
                    end
                    if ((main_basesoc_sentinel_bus_sel & 2'd2)) begin
                        main_basesoc_bus_dat_r_override[15:8] <= main_basesoc_interrupt_reg[15:8];
                    end
                    if ((main_basesoc_sentinel_bus_sel & 3'd4)) begin
                        main_basesoc_bus_dat_r_override[23:16] <= main_basesoc_interrupt_reg[23:16];
                    end
                    if ((main_basesoc_sentinel_bus_sel & 4'd8)) begin
                        main_basesoc_bus_dat_r_override[31:24] <= main_basesoc_interrupt_reg[31:24];
                    end
                    main_basesoc_bus_ack_override <= 1'd1;
                end else begin
                    if ((main_basesoc_sentinel_bus_adr == 3'd5)) begin
                        if ((main_basesoc_sentinel_bus_sel & 1'd1)) begin
                            main_basesoc_bus_dat_r_override[7:0] <= main_basesoc_interrupt_mask[7:0];
                        end
                        if ((main_basesoc_sentinel_bus_sel & 2'd2)) begin
                            main_basesoc_bus_dat_r_override[15:8] <= main_basesoc_interrupt_mask[15:8];
                        end
                        if ((main_basesoc_sentinel_bus_sel & 3'd4)) begin
                            main_basesoc_bus_dat_r_override[23:16] <= main_basesoc_interrupt_mask[23:16];
                        end
                        if ((main_basesoc_sentinel_bus_sel & 4'd8)) begin
                            main_basesoc_bus_dat_r_override[31:24] <= main_basesoc_interrupt_mask[31:24];
                        end
                        main_basesoc_bus_ack_override <= 1'd1;
                    end
                end
    ...
    if ((((main_basesoc_sentinel_bus_cyc & main_basesoc_sentinel_bus_stb) & main_basesoc_sentinel_bus_we) & (main_basesoc_sentinel_bus_adr[29:26] == 1'd0))) begin
        main_basesoc_bus_ack_override <= 1'd1;
    end
    main_basesoc_interrupt_reg <= main_basesoc_litex_interrupts;
    if ((((main_basesoc_sentinel_bus_cyc & main_basesoc_sentinel_bus_stb) & main_basesoc_sentinel_bus_ack) & main_basesoc_sentinel_bus_we)) begin
        if ((main_basesoc_sentinel_bus_adr == 3'd4)) begin
            if ((main_basesoc_sentinel_bus_sel & 1'd1)) begin
                main_basesoc_interrupt_reg[7:0] <= main_basesoc_sentinel_bus_dat_w[7:0];
            end
            if ((main_basesoc_sentinel_bus_sel & 2'd2)) begin
                main_basesoc_interrupt_reg[15:8] <= main_basesoc_sentinel_bus_dat_w[15:8];
            end
            if ((main_basesoc_sentinel_bus_sel & 3'd4)) begin
                main_basesoc_interrupt_reg[23:16] <= main_basesoc_sentinel_bus_dat_w[23:16];
            end
            if ((main_basesoc_sentinel_bus_sel & 4'd8)) begin
                main_basesoc_interrupt_reg[31:24] <= main_basesoc_sentinel_bus_dat_w[31:24];
            end
        end else begin
            if ((main_basesoc_sentinel_bus_adr == 3'd5)) begin
                if ((main_basesoc_sentinel_bus_sel & 1'd1)) begin
                    main_basesoc_interrupt_mask[7:0] <= main_basesoc_sentinel_bus_dat_w[7:0];
                end
                if ((main_basesoc_sentinel_bus_sel & 2'd2)) begin
                    main_basesoc_interrupt_mask[15:8] <= main_basesoc_sentinel_bus_dat_w[15:8];
                end
                if ((main_basesoc_sentinel_bus_sel & 3'd4)) begin
                    main_basesoc_interrupt_mask[23:16] <= main_basesoc_sentinel_bus_dat_w[23:16];
                end
                if ((main_basesoc_sentinel_bus_sel & 4'd8)) begin
                    main_basesoc_interrupt_mask[31:24] <= main_basesoc_sentinel_bus_dat_w[31:24];
                end
            end
        end
    end
    ...
    if (builder_csr_bankarray_csrbank2_load0_re) begin
        main_basesoc_timer_load_storage <= builder_csr_bankarray_csrbank2_load0_r;
    end
    main_basesoc_timer_load_re <= builder_csr_bankarray_csrbank2_load0_re;
    if (builder_csr_bankarray_csrbank2_reload0_re) begin
        main_basesoc_timer_reload_storage <= builder_csr_bankarray_csrbank2_reload0_r;
    end
    ...
    if (builder_csr_bankarray_csrbank3_ev_pending_re) begin
        main_basesoc_uart_pending_r <= builder_csr_bankarray_csrbank3_ev_pending_r;
    end
    ...
    if (builder_csr_bankarray_csrbank3_ev_enable0_re) begin
        main_basesoc_uart_enable_storage <= builder_csr_bankarray_csrbank3_ev_enable0_r;
    end
    ...
    if (sys_rst) begin
        ...
        main_basesoc_interrupt_reg <= 32'd0;
        main_basesoc_interrupt_mask <= 32'd0;
        main_basesoc_bus_dat_r_override <= 32'd0;
        main_basesoc_bus_ack_override <= 1'd0;
        main_basesoc_basesoc_ram_bus_ack <= 1'd0;
        main_basesoc_ram_bus_ram_bus_ack <= 1'd0;
        serial_tx <= 1'd1;
...
//------------------------------------------------------------------------------
// Instance sentinel_cpu of sentinel_cpu Module.
//------------------------------------------------------------------------------
sentinel_cpu sentinel_cpu(
	// Inputs.
	.bus__ack   (main_basesoc_sentinel_bus_ack),
	.bus__dat_r (main_basesoc_sentinel_bus_dat_r),
	.clk        (sys_clk),
	.irq        (main_basesoc_sentinel_irq),
	.rst        ((sys_rst | main_basesoc_reset)),

	// Outputs.
	.bus__adr   (main_basesoc_sentinel_bus_adr),
	.bus__cyc   (main_basesoc_sentinel_bus_cyc),
	.bus__dat_w (main_basesoc_sentinel_bus_dat_w),
	.bus__sel   (main_basesoc_sentinel_bus_sel),
	.bus__stb   (main_basesoc_sentinel_bus_stb),
	.bus__we    (main_basesoc_sentinel_bus_we)
);
...
// -----------------------------------------------------------------------------
//  Auto-Generated by LiteX on 2025-05-09 16:24:36.
//------------------------------------------------------------------------------
