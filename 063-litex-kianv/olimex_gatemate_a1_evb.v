...
wire          main_done;
wire          main_kianv;
wire          main_kianv_idbus_ack;
wire   [31:0] main_kianv_idbus_adr;
reg     [1:0] main_kianv_idbus_bte = 2'd0;
reg     [2:0] main_kianv_idbus_cti = 3'd0;
wire          main_kianv_idbus_cyc;
wire   [31:0] main_kianv_idbus_dat_r;
wire   [31:0] main_kianv_idbus_dat_w;
wire          main_kianv_idbus_err;
wire    [3:0] main_kianv_idbus_sel;
wire          main_kianv_idbus_stb;
wire          main_kianv_idbus_we;
wire   [31:0] main_kianv_mbus_addr;
wire   [31:0] main_kianv_mbus_rdata;
wire          main_kianv_mbus_ready;
wire          main_kianv_mbus_valid;
wire   [31:0] main_kianv_mbus_wdata;
wire    [3:0] main_kianv_mbus_wstrb;
wire          main_kianv_reset;
reg           main_leds = 1'd0;
wire          main_locked;
reg           main_mode = 1'd0;
...
assign main_kianv_reset = (main_soc_rst | main_cpu_rst);
...
assign main_adapted_interface_dat_w = main_kianv_idbus_dat_w;
assign main_kianv_idbus_dat_r = main_adapted_interface_dat_r;
assign main_adapted_interface_sel = main_kianv_idbus_sel;
assign main_adapted_interface_cyc = main_kianv_idbus_cyc;
assign main_adapted_interface_stb = main_kianv_idbus_stb;
assign main_kianv_idbus_ack = main_adapted_interface_ack;
assign main_adapted_interface_we = main_kianv_idbus_we;
assign main_adapted_interface_cti = main_kianv_idbus_cti;
assign main_adapted_interface_bte = main_kianv_idbus_bte;
assign main_kianv_idbus_err = main_adapted_interface_err;
assign main_adapted_interface_adr = main_kianv_idbus_adr[31:2];
...
assign main_kianv_idbus_stb = main_kianv_mbus_valid;
assign main_kianv_idbus_cyc = main_kianv_mbus_valid;
assign main_kianv_mbus_ready = main_kianv_idbus_ack;
assign main_kianv_idbus_we = (main_kianv_mbus_wstrb != 1'd0);
assign main_kianv_idbus_adr = main_kianv_mbus_addr;
assign main_kianv_idbus_sel = main_kianv_mbus_wstrb;
assign main_kianv_idbus_dat_w = main_kianv_mbus_wdata;
assign main_kianv_mbus_rdata = main_kianv_idbus_dat_r;
...
always @(*) begin
    ...
    case (builder_grant)
        default: begin
            builder_self0 <= main_adapted_interface_adr;
        end
    endcase
end
always @(*) begin
    ...
    case (builder_grant)
        default: begin
            builder_self1 <= main_adapted_interface_dat_w;
        end
    endcase
end
always @(*) begin
    ...
    case (builder_grant)
        default: begin
            builder_self2 <= main_adapted_interface_sel;
        end
    endcase
end
always @(*) begin
    ...
    case (builder_grant)
        default: begin
            builder_self3 <= main_adapted_interface_cyc;
        end
    endcase
end
always @(*) begin
    ...
    case (builder_grant)
        default: begin
            builder_self4 <= main_adapted_interface_stb;
        end
    endcase
end
always @(*) begin
    ...
    case (builder_grant)
        default: begin
            builder_self5 <= main_adapted_interface_we;
        end
    endcase
end
always @(*) begin
    ...
    case (builder_grant)
        default: begin
            builder_self6 <= main_adapted_interface_cti;
        end
    endcase
end
always @(*) begin
    ...
    case (builder_grant)
        default: begin
            builder_self7 <= main_adapted_interface_bte;
        end
    endcase
end
...
//------------------------------------------------------------------------------
// Instance kianv_harris_mc_edition of kianv_harris_mc_edition Module.
//------------------------------------------------------------------------------
kianv_harris_mc_edition #(
	// Parameters.
	.RESET_ADDR (32'd0),
	...
	.access_fault (1'd0),
	.clk          (sys_clk),
	.mem_rdata    (main_kianv_mbus_rdata),
	.mem_ready    (main_kianv_mbus_ready),
	.resetn       ((~(sys_rst | main_kianv_reset))),

	// Outputs.
	.PC           (main_kianv),
	.mem_addr     (main_kianv_mbus_addr),
	.mem_valid    (main_kianv_mbus_valid),
	.mem_wdata    (main_kianv_mbus_wdata),
	.mem_wstrb    (main_kianv_mbus_wstrb)
);
