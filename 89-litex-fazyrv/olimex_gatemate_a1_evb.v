...
wire          main_done;
wire          main_fazyrv;
wire          main_fazyrv_dbus_ack;
wire   [31:0] main_fazyrv_dbus_adr;
reg     [1:0] main_fazyrv_dbus_bte = 2'd0;
reg     [2:0] main_fazyrv_dbus_cti = 3'd0;
wire          main_fazyrv_dbus_cyc;
wire   [31:0] main_fazyrv_dbus_dat_r;
wire   [31:0] main_fazyrv_dbus_dat_w;
wire          main_fazyrv_dbus_err;
wire    [3:0] main_fazyrv_dbus_sel;
wire          main_fazyrv_dbus_stb;
wire          main_fazyrv_dbus_we;
wire          main_fazyrv_ibus_ack;
wire   [31:0] main_fazyrv_ibus_adr;
reg     [1:0] main_fazyrv_ibus_bte = 2'd0;
reg     [2:0] main_fazyrv_ibus_cti = 3'd0;
wire          main_fazyrv_ibus_cyc;
wire   [31:0] main_fazyrv_ibus_dat_r;
reg    [31:0] main_fazyrv_ibus_dat_w = 32'd0;
wire          main_fazyrv_ibus_err;
reg     [3:0] main_fazyrv_ibus_sel = 4'd0;
wire          main_fazyrv_ibus_stb;
reg           main_fazyrv_ibus_we = 1'd0;
wire          main_fazyrv_reset;
...
assign main_fazyrv_reset = (main_soc_rst | main_cpu_rst);
...
assign main_interface0_adapted_interface_dat_w = main_fazyrv_ibus_dat_w;
assign main_fazyrv_ibus_dat_r = main_interface0_adapted_interface_dat_r;
assign main_interface0_adapted_interface_sel = main_fazyrv_ibus_sel;
assign main_interface0_adapted_interface_cyc = main_fazyrv_ibus_cyc;
assign main_interface0_adapted_interface_stb = main_fazyrv_ibus_stb;
assign main_fazyrv_ibus_ack = main_interface0_adapted_interface_ack;
assign main_interface0_adapted_interface_we = main_fazyrv_ibus_we;
assign main_interface0_adapted_interface_cti = main_fazyrv_ibus_cti;
assign main_interface0_adapted_interface_bte = main_fazyrv_ibus_bte;
assign main_fazyrv_ibus_err = main_interface0_adapted_interface_err;
assign main_interface0_adapted_interface_adr = main_fazyrv_ibus_adr[31:2];
assign main_interface1_adapted_interface_dat_w = main_fazyrv_dbus_dat_w;
assign main_fazyrv_dbus_dat_r = main_interface1_adapted_interface_dat_r;
assign main_interface1_adapted_interface_sel = main_fazyrv_dbus_sel;
assign main_interface1_adapted_interface_cyc = main_fazyrv_dbus_cyc;
assign main_interface1_adapted_interface_stb = main_fazyrv_dbus_stb;
assign main_fazyrv_dbus_ack = main_interface1_adapted_interface_ack;
assign main_interface1_adapted_interface_we = main_fazyrv_dbus_we;
assign main_interface1_adapted_interface_cti = main_fazyrv_dbus_cti;
assign main_interface1_adapted_interface_bte = main_fazyrv_dbus_bte;
assign main_fazyrv_dbus_err = main_interface1_adapted_interface_err;
assign main_interface1_adapted_interface_adr = main_fazyrv_dbus_adr[31:2];
...
always @(*) begin
    ...
    case (builder_grant)
        1'd0: begin
            builder_self0 <= main_interface0_adapted_interface_adr;
        end
        default: begin
            builder_self0 <= main_interface1_adapted_interface_adr;
        end
    endcase
end
always @(*) begin
    ...
    case (builder_grant)
        1'd0: begin
            builder_self1 <= main_interface0_adapted_interface_dat_w;
        end
        default: begin
            builder_self1 <= main_interface1_adapted_interface_dat_w;
        end
    endcase
end
always @(*) begin
    ...
    case (builder_grant)
        1'd0: begin
            builder_self2 <= main_interface0_adapted_interface_sel;
        end
        default: begin
            builder_self2 <= main_interface1_adapted_interface_sel;
        end
    endcase
end
always @(*) begin
    ...
    case (builder_grant)
        1'd0: begin
            builder_self3 <= main_interface0_adapted_interface_cyc;
        end
        default: begin
            builder_self3 <= main_interface1_adapted_interface_cyc;
        end
    endcase
end
always @(*) begin
    ...
    case (builder_grant)
        1'd0: begin
            builder_self4 <= main_interface0_adapted_interface_stb;
        end
        default: begin
            builder_self4 <= main_interface1_adapted_interface_stb;
        end
    endcase
end
always @(*) begin
    ...
    case (builder_grant)
        1'd0: begin
            builder_self5 <= main_interface0_adapted_interface_we;
        end
        default: begin
            builder_self5 <= main_interface1_adapted_interface_we;
        end
    endcase
end
always @(*) begin
    ...
    case (builder_grant)
        1'd0: begin
            builder_self6 <= main_interface0_adapted_interface_cti;
        end
        default: begin
            builder_self6 <= main_interface1_adapted_interface_cti;
        end
    endcase
end
always @(*) begin
    ...
    case (builder_grant)
        1'd0: begin
            builder_self7 <= main_interface0_adapted_interface_bte;
        end
        default: begin
            builder_self7 <= main_interface1_adapted_interface_bte;
        end
    endcase
end
...
//------------------------------------------------------------------------------
// Memory rom: 6095-words x 32-bit
//------------------------------------------------------------------------------
...
//------------------------------------------------------------------------------
// Instance fazyrv_top of fazyrv_top Module.
//------------------------------------------------------------------------------
fazyrv_top #(
	// Parameters.
	.BOOTADR   (32'd0),
	...
	// Inputs.
	.clk_i         (sys_clk),
	.rst_in        ((~(sys_rst | main_fazyrv_reset))),
	.tirq_i        (1'd0),
	.wb_dmem_ack_i (main_fazyrv_dbus_ack),
	.wb_dmem_dat_i (main_fazyrv_dbus_dat_r),
	.wb_imem_ack_i (main_fazyrv_ibus_ack),
	.wb_imem_dat_i (main_fazyrv_ibus_dat_r),

	// Outputs.
	.trap_o        (main_fazyrv),
	.wb_dmem_adr_o (main_fazyrv_dbus_adr),
	.wb_dmem_be_o  (main_fazyrv_dbus_sel),
	.wb_dmem_cyc_o (main_fazyrv_dbus_cyc),
	.wb_dmem_dat_o (main_fazyrv_dbus_dat_w),
	.wb_dmem_stb_o (main_fazyrv_dbus_stb),
	.wb_dmem_we_o  (main_fazyrv_dbus_we),
	.wb_imem_adr_o (main_fazyrv_ibus_adr),
	.wb_imem_cyc_o (main_fazyrv_ibus_cyc),
	.wb_imem_stb_o (main_fazyrv_ibus_stb)
);
...
// -----------------------------------------------------------------------------
//  Auto-Generated by LiteX on 2025-05-09 14:17:13.
//------------------------------------------------------------------------------
