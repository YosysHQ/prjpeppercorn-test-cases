...
wire   [31:0] main_picorv32_idbus_adr;
...
reg     [3:0] main_picorv32_idbus_sel = 4'd0;
wire          main_picorv32_idbus_stb;
reg           main_picorv32_idbus_we = 1'd0;
...
always @(*) begin
    ...
    main_picorv32_interrupt[4] <= main_timer_irq;
    main_picorv32_interrupt[3] <= main_uart_irq;
end
...
assign main_adapted_interface_dat_w = main_picorv32_idbus_dat_w;
assign main_picorv32_idbus_dat_r = main_adapted_interface_dat_r;
assign main_adapted_interface_sel = main_picorv32_idbus_sel;
assign main_adapted_interface_cyc = main_picorv32_idbus_cyc;
assign main_adapted_interface_stb = main_picorv32_idbus_stb;
assign main_picorv32_idbus_ack = main_adapted_interface_ack;
assign main_adapted_interface_we = main_picorv32_idbus_we;
assign main_adapted_interface_cti = main_picorv32_idbus_cti;
assign main_adapted_interface_bte = main_picorv32_idbus_bte;
assign main_picorv32_idbus_err = main_adapted_interface_err;
assign main_adapted_interface_adr = main_picorv32_idbus_adr[31:2];
...
assign main_picorv32_idbus_adr = main_picorv32_mem_addr;
assign main_picorv32_idbus_dat_w = main_picorv32_mem_wdata;
always @(*) begin
    main_picorv32_idbus_sel <= 4'd0;
    main_picorv32_idbus_we <= 1'd0;
    if ((main_picorv32_mem_wstrb != 1'd0)) begin
        main_picorv32_idbus_we <= 1'd1;
        main_picorv32_idbus_sel <= main_picorv32_mem_wstrb;
    end else begin
        main_picorv32_idbus_we <= 1'd0;
        main_picorv32_idbus_sel <= 4'd15;
    end
end
...
//------------------------------------------------------------------------------
// Memory rom: 6189-words x 32-bit
//------------------------------------------------------------------------------
...
// -----------------------------------------------------------------------------
//  Auto-Generated by LiteX on 2025-04-08 08:20:40.
//------------------------------------------------------------------------------
