...
reg    [31:0] main_basesoc_idbus_adr_next_value0 = 32'd0;
reg           main_basesoc_idbus_adr_next_value_ce0 = 1'd0;
...
reg    [31:0] main_basesoc_idbus_dat_w_next_value1 = 32'd0;
reg           main_basesoc_idbus_dat_w_next_value_ce1 = 1'd0;
wire          main_basesoc_idbus_err;
reg     [3:0] main_basesoc_idbus_sel = 4'd0;
reg     [3:0] main_basesoc_idbus_sel_next_value2 = 4'd0;
reg           main_basesoc_idbus_sel_next_value_ce2 = 1'd0;
reg           main_basesoc_idbus_stb = 1'd0;
reg           main_basesoc_idbus_we = 1'd0;
reg           main_basesoc_idbus_we_next_value3 = 1'd0;
reg           main_basesoc_idbus_we_next_value_ce3 = 1'd0;
...
always @(*) begin
    ...
    main_basesoc_idbus_adr_next_value0 <= 32'd0;
    main_basesoc_idbus_adr_next_value_ce0 <= 1'd0;
    main_basesoc_idbus_cyc <= 1'd0;
    main_basesoc_idbus_dat_w_next_value1 <= 32'd0;
    main_basesoc_idbus_dat_w_next_value_ce1 <= 1'd0;
    main_basesoc_idbus_sel_next_value2 <= 4'd0;
    main_basesoc_idbus_sel_next_value_ce2 <= 1'd0;
    main_basesoc_idbus_stb <= 1'd0;
    main_basesoc_idbus_we_next_value3 <= 1'd0;
    main_basesoc_idbus_we_next_value_ce3 <= 1'd0;
    ...
    case (builder_femtorv_state)
        ...
        default: begin
            main_basesoc_idbus_adr_next_value0 <= main_basesoc_mbus_addr;
            main_basesoc_idbus_adr_next_value_ce0 <= 1'd1;
            main_basesoc_idbus_dat_w_next_value1 <= main_basesoc_mbus_wdata;
            main_basesoc_idbus_dat_w_next_value_ce1 <= 1'd1;
            main_basesoc_idbus_sel_next_value2 <= main_basesoc_mbus_wmask;
            main_basesoc_idbus_sel_next_value_ce2 <= 1'd1;
            if ((main_basesoc_mbus_rstrb | (main_basesoc_mbus_wmask != 1'd0))) begin
                main_basesoc_idbus_we_next_value3 <= (main_basesoc_mbus_wmask != 1'd0);
                main_basesoc_idbus_we_next_value_ce3 <= 1'd1;
...
always @(posedge sys_clk) begin
    ...
    if (main_basesoc_idbus_adr_next_value_ce0) begin
        main_basesoc_idbus_adr <= main_basesoc_idbus_adr_next_value0;
    end
    if (main_basesoc_idbus_dat_w_next_value_ce1) begin
        main_basesoc_idbus_dat_w <= main_basesoc_idbus_dat_w_next_value1;
    end
    if (main_basesoc_idbus_sel_next_value_ce2) begin
        main_basesoc_idbus_sel <= main_basesoc_idbus_sel_next_value2;
    end
    if (main_basesoc_idbus_we_next_value_ce3) begin
        main_basesoc_idbus_we <= main_basesoc_idbus_we_next_value3;
    end
...
// -----------------------------------------------------------------------------
//  Auto-Generated by LiteX on 2025-04-08 08:17:59.
//------------------------------------------------------------------------------
