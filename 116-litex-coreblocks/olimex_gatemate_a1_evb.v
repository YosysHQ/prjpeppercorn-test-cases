...
reg    [15:0] main_basesoc_interrupt = 16'd0;
wire   [31:0] main_basesoc_interrupts_full;
...
always @(*) begin
    ...
    builder_slave_sel[2] <= (builder_shared_adr[29:14] == 16'd57344);
end
...
assign main_basesoc_interrupts_full = (main_basesoc_interrupt <<< 5'd16);
...
always @(posedge sys_clk) begin
    ...
    {main_basesoc_tx_tick, main_basesoc_tx_phase} <= 25'd32985348;
    if (main_basesoc_tx_enable) begin
        {main_basesoc_tx_tick, main_basesoc_tx_phase} <= (main_basesoc_tx_phase + 25'd32985348);
    end
    ...
    if (main_basesoc_rx_enable) begin
        {main_basesoc_rx_tick, main_basesoc_rx_phase} <= (main_basesoc_rx_phase + 25'd32985348);
    end
...
//------------------------------------------------------------------------------
// Memory rom: 6051-words x 32-bit
//------------------------------------------------------------------------------
...
//------------------------------------------------------------------------------
// Instance top of top Module.
//------------------------------------------------------------------------------
top top(
	// Inputs.
	.clk             (sys_clk),
	.interrupts      (main_basesoc_interrupts_full),
	.rst             ((sys_rst | main_basesoc_reset)),
	.wb_data__ack    (main_basesoc_dbus_ack),
	.wb_data__dat_r  (main_basesoc_dbus_dat_r),
	.wb_data__err    (main_basesoc_dbus_err),
	.wb_instr__ack   (main_basesoc_ibus_ack),
	.wb_instr__dat_r (main_basesoc_ibus_dat_r),
	.wb_instr__err   (main_basesoc_ibus_err),

	// Outputs.
	.wb_data__adr    (main_basesoc_dbus_adr),
	.wb_data__cyc    (main_basesoc_dbus_cyc),
	.wb_data__dat_w  (main_basesoc_dbus_dat_w),
	.wb_data__sel    (main_basesoc_dbus_sel),
	.wb_data__stb    (main_basesoc_dbus_stb),
	.wb_data__we     (main_basesoc_dbus_we),
	.wb_instr__adr   (main_basesoc_ibus_adr),
	.wb_instr__cyc   (main_basesoc_ibus_cyc),
	.wb_instr__dat_w (main_basesoc_ibus_dat_w),
	.wb_instr__sel   (main_basesoc_ibus_sel),
	.wb_instr__stb   (main_basesoc_ibus_stb),
	.wb_instr__we    (main_basesoc_ibus_we)
);
...
// -----------------------------------------------------------------------------
//  Auto-Generated by LiteX on 2025-09-03 14:21:16.
//------------------------------------------------------------------------------
